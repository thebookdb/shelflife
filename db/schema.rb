...
ActiveRecord::Schema[8.1].define(version: 2026_01_31_032317) do
  ...
  create_table "library_items", force: :cascade do |t|
    ...
    t.index ["added_by_id"], name: "index_library_items_on_added_by_id"
    t.index ["condition_id"], name: "index_library_items_on_condition_id"
    t.index ["intent"], name: "index_library_items_on_intent"
    ...
    t.index ["updated_by_id"], name: "index_library_items_on_updated_by_id"
  end
