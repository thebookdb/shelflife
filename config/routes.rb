Rails.application.routes.draw do
  ...
  # Mission Control Jobs interface for development/debugging
  # Only available in development to avoid authentication conflicts
  ...
  patch "/profile/dashboard_settings", to: "user#update_dashboard_setting"
